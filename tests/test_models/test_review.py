...
class TestReview(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """test that values in dict returned from to_dict are of given type"""
        r = Review()
        new_d = r.to_dict()
        self.assertEqual(new_d["__class__"], "Review")
        self.assertEqual(type(new_d["created_at"]), str)
        self.assertEqual(type(new_d["updated_at"]), str)
        self.assertEqual(new_d["created_at"], r.created_at.isoformat())
        self.assertEqual(new_d["updated_at"], r.updated_at.isoformat())
